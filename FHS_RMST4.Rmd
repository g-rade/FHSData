...
all_data2_aspirin0 <- all_data2 %>% 
  filter(H010 == 0) %>% 
  mutate(TXB2_quart = if_else(ratio >= 6483.42, "Q4", NULL)) %>% 
...
all_data2_aspirin0$TXB2_quart[all_data2_aspirin0$ratio < 6483.42] <- "Q3"
...
all_data2_aspirin1 <- all_data2 %>% 
  filter(H010 == 1) %>% 
  mutate(TXB2_quart = if_else(ratio >= 1700.82, "Q4", NULL)) %>% 
  mutate(youden = if_else(ratio >= 1300, "high", "low")) %>% 
  mutate(youden2 = if_else(ratio2 >= 18.6, "high", "low")) %>% 
...
export(all_data2, "rmst_egfr2.csv")
```
