...
all_data2 <- all_data2 %>% 
  mutate(years = days/365.25, censor5 = if_else(years > 5, 1, NULL), censor10 = if_else(years > 10, 1, NULL), censor12 = if_else(years > 12, 1, NULL)) ## creating the years variable and the new censor variables for different taus 

all_data2$censor5[all_data2$years <= 5] <- 0
all_data2$censor10[all_data2$years <= 10] <- 0
all_data2$censor12[all_data2$years <= 5] <- 0
...
all_data2 <- all_data2 %>% 
  mutate(years5 = years, years10 = years, years12 = years)  ## making new years variables for the different taus we want to use
...
export(all_data2, "rmst_freq12.csv")
