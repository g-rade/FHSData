...
all_data2 <- all_data2 %>% 
  mutate(years = days/365.25, censor4 = if_else(years > 4, 1, 0), censor10 = if_else(years > 10, 1, 0), censor12 = if_else(years > 12, 1, 0), censor14 = if_else(years > 14.8, 1, 0)) ## creating the years variable and the new censor variables for different taus 

all_data2 <- all_data2 %>% 
  mutate(years5 = if_else(years > 5, 5, NULL), years10 = if_else(years > 10, 10, NULL), years12 = if_else(years > 12, 12, NULL), years14 = if_else(years > 14.8, 14.8, NULL))  ## making new years variables for the different taus we want to use

# exportng the dataset as a .csv file 
export(all_data2, "rmst_freq8.csv")
