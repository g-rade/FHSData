...
all_data2 <- all_data2 %>% 
  mutate(years = days/365.25, censor5 = censor, censor10 = censor, censor13 = censor)  

all_data2$censor5[all_data2$years > 5] <- 1
all_data2$censor10[all_data2$years > 10] <- 1
all_data2$censor12[all_data2$years >13] <- 1
...
all_data2$years12[all_data2$years > 13 | is.na(all_data2$years)] <- 13
...
export(all_data2, "rmst_methods_paper6.csv")
```
