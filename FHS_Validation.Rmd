...
validation_data <- read_excel("Master Database.Revised FinalCohort.15Nov22.xlsx") %>% 
  rename(dead_days = 'Date of Death POD', event_free = 'Death/LVAD/Tx POD', last_con = 'Last Known Status  POD', Event = 'Death/LVAD/Tx', TXB_group1 = 'TXB2-M (>/=1500) Group', TXB_group2 = 'TXB2-M (>1291)', EGFR_group = 'TXB2-M/eGFR Group') 
...
## export data
export(validation_data, "validation13.csv")
